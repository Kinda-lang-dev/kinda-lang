...
"""
        ...
        self.assertIn(
            "req = maybe_import('requests', alias='req', fallback_module='urllib')", result
        )
...
"""
        ...
        with patch("kinda.personality.chaos_probability") as mock_prob, patch(
            "kinda.personality.update_chaos_state"
        ) as mock_update, patch("kinda.personality.get_personality") as mock_get_pers:
...
"""
    ...
    def test_line_by_line_transformation(self):
        ...
        test_cases = [
            ...
            (
                "~maybe import requests ~welp urllib",
                "requests = maybe_import('requests', fallback_module='urllib')",
            ),
            (
                "~maybe import requests as req ~welp urllib",
                "req = maybe_import('requests', alias='req', fallback_module='urllib')",
            ),
        ]
