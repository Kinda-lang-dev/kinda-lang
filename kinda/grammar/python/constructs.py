...
KindaPythonConstructs = {
    ...
    "kinda_import": {
        "type": "import",
        "pattern": re.compile(r'~kinda import\s+([a-zA-Z_]\w*(?:\.[a-zA-Z_]\w*)*)(?:\s+as\s+([a-zA-Z_]\w*))?(?:\s*#.*)?(?:;|$)'),
    ...
    "maybe_import": {
        "type": "import",
        "pattern": re.compile(r'~maybe import\s+([a-zA-Z_]\w*(?:\.[a-zA-Z_]\w*)*)(?:\s+as\s+([a-zA-Z_]\w*))?(?:\s*~welp\s+(.+?))?(?:\s*#.*)?(?:;|$)'),
